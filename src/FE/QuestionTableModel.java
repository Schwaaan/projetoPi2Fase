...
public class QuestionTableModel extends AbstractTableModel {
    ...
    private String[] columns = new String[] {"Id", "Id do Professor", "Quest√£o"};
    ...
    // implementado apenzas porque √© obrigat√≥rio, mas n√£o iremos usar por enquanto
    
    
    
    
    //victor
    //onde tem os botıes precisa criar o metodo recarregar 
    @Override
        ...
        if (rowIndex >= 0 && rowIndex <= tasks.size()) {
            ...
            switch (colIndex) {
                ...
                case 2:
                    ...
                    break;
                default:
                    System.err.printf("[ERRO] Õndice e coluna inv·lido: %d\n", colIndex);
                    break;
            }
        }
